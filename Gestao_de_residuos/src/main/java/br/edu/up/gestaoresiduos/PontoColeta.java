...
public class PontoColeta implements FormatoEscrita {
    ...
    public double getQuantidadeMetal() {
        return pontoMetal.getQuantidade();
    }
    public double getQuantidadeVidro() {
        return pontoVidro.getQuantidade();
    }
    public double getQuantidadePlastico() {
        return pontoPlastico.getQuantidade();
    }
    public double getQuantidadePapel() {
        return pontoPapel.getQuantidade();
    }
